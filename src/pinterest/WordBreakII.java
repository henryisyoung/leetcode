...
public class WordBreakII {
    ...
    public List<String> wordBreakMemo(String s, List<String> wordDict) {
        ...
        set.addAll(wordDict);
        return dfsSearchAllMemo(0, s, set, map);
    }

    private List<String> dfsSearchAllMemo(int start, String s, Set<String> set, Map<Integer, List<String>> map) {
        ...
        for (int i = start + 1; i <= s.length(); i++) {
            ...
            List<String> nexts = dfsSearchAllMemo(i, s, set, map);
