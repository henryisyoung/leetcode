...
public class SlidingPuzzleShortestPath {
    public int slidingPuzzle(int[][] board) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int[] di: directions) {
                ...
                path.put(nei.boardstring, node.boardstring);
            }
        }
        return -1;
    }
    ...
    class Node {
        ...
        Node(int[][] B, int r, int c, int d) {
            this.board = B;
            boardstring = Arrays.deepToString(this.board);
            zero_r = r;
            zero_c = c;
            depth = d;
        }
    ...
    public static void main(String[] args) {
        ...
        SlidingPuzzleShortestPath solver = new SlidingPuzzleShortestPath();
