...
//            System.out.println("words[i] " + words[i] + " list : " + root.palins.toString());
    ...
    public static void main(String[] args) {
        ...
        PalindromePairsTrie pp = new PalindromePairsTrie();
//        List<List<Integer>> list = pp.palindromePairs(words);
        List<List<Integer>> list2 = pp.palindromePairs(words2);
