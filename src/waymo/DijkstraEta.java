...
public class DijkstraEta {
    ...
    private static void runFromStdin() throws IOException {
        ...
        System.out.println(new DijkstraEta().eta(n, edges, s, t));
    }

    /* --------------------------- Demo + tests --------------------------- */

    private static void runDemos() {
        DijkstraEta solver = new DijkstraEta();
    ...
    private static void check(DijkstraEta solver, int n, int[][] edges, int s, int t, long expected) {
